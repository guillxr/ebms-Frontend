...
export function NavMain({
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjViNWM4MTVkLTYwYTItNDM3Yy05Yjc4LTA0ZDc5YTk2YWE3YyIsInJvbGUiOiJBRE1JTiIsImlhdCI6MTc1MjcyMDc5NCwiZXhwIjoxNzUyODA3MTk0fQ.y9nnYHKswKXiHnKwJlQuKdZDujfQ0C0ybZGWjdkz9_Y"
  ...
  const onSubmit = async (data: SchedulingFormData) => {
    try {
      await createScheduling(
        {
          usuario_id: "9291e6ac-3759-43b2-b109-e1175978ca69",
      ...
      reset()
      setOpen(false)
      triggerRefresh() // ⬅ chama atualização via contexto
    } catch (err) {
      console.error(err)
